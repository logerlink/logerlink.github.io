...
const priorityArr = [1002, 1006, 1008, 1013]
...
export function createSiteMap() {
    ...
    let allTxt = `<?xml version="1.0" encoding="UTF-8"?>
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    <url>
        <loc>https://logerlink.github.io/category.html</loc>
        <lastmod>2024-08-16</lastmod>
        <changefreq>weekly</changefreq>
        <priority>0.8</priority>
    </url>${items.reverse().join('')}
</urlset>`
    return allTxt;
}
