...
```csharp
        ...
        public static bool ResizeImage(string sFile, string dFile, int scale = 2, int quality = 90)
        {
            ...
            g.DrawImage(sourceImage, 0, 0, xWidth / scale, yWidth / scale);
            g.Dispose();
...
[Gifsicle: Command-Line Animated GIFs (lcdf.org)](https://www.lcdf.org/gifsicle/)

查看GIF的结构

```shell
gifsicle --info city.gif
```

![image-20211117171729272](https://i.loli.net/2021/11/17/XQtigW4ECVPH6sm.png)
...
参考：[C# 图片添加水印 - simadi - 博客园 (cnblogs.com)](https://www.cnblogs.com/simadi/p/15355480.html)

[C#图片添加文字水印 - 渴望运动的胖子 - 博客园 (cnblogs.com)](https://www.cnblogs.com/li-learning/p/WaterMark.html) 文字旋转

![water_markText](https://i.loli.net/2021/11/17/6YPaXCsuoRSbnyO.jpg)
...
[C# 给图片添加透明的文字、图片水印 - slyly - 博客园 (cnblogs.com)](https://www.cnblogs.com/shiliang199508/p/9238868.html)

![water_markImg](https://i.loli.net/2021/11/17/4BrdOSyolimYKgP.png)
...
<img src="https://i.loli.net/2021/11/17/hW6wmAoaIC1f9Zb.gif" alt="star_markGifCenter_compress" style="zoom:50%;" />
...
![CompressGifVM622e2f19-9a4e-4591-8257-215c44a43b9a_star_markImgGif](https://i.loli.net/2021/11/20/i4HusFbqGVdQRe2.gif)
...
![water_fullMarkChinese](https://i.loli.net/2021/11/17/DUyG7OhfSHmTrxa.jpg)
...
![star_fullMarkGifChinese_compress](https://i.loli.net/2021/11/17/h7OjZaU6xKFwvAr.gif)
...
更多请参考：[micjahn/ZXing.Net: .Net port of the original java-based barcode reader and generator library zxing (github.com)](https://github.com/micjahn/ZXing.Net)

[C# ZXing.Net生成二维码、识别二维码、生成带Logo的二维码（一） - 天马3798 - 博客园 (cnblogs.com)](https://www.cnblogs.com/tianma3798/p/5426869.html)

![image-20211120181110966](https://i.loli.net/2021/11/20/yD4tKIaRqX6Ozlo.png)
...
![image-20211117182350667](https://i.loli.net/2021/11/17/Z7bRaDyYgMGus9h.png)

2. 源码：[GitHub - logerlink/ImageTools: 简单的图片/GIF操作工具。可用于图片/GIF压缩、创建缩略图、添加文本水印、图像水印、创建/解析二维码、条形码](https://github.com/logerlink/ImageTools)
